...
conc_isavuco_5mg_kg <- read_csv("Sim5.csv", 
  ...
  # to select less id to run algorithms fasters
  filter(id<300)
...
```{r wf xgb tune , cache=TRUE, fig.width=10, fig.height=7}
...
```{r wf mlp sim , cache=T, fig.width=10, fig.height=7}
#model
##nouveau parametre stop_iter
...
```{r wf rf sim , cache=T, fig.width=10, fig.height=7}
#model
##nouveau parametre stop_iter
